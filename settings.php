...
$CustomerCustomerSignup = isset($config['SMSHTML']['CustomerCustomerSignup']) ? stripcslashes($config['SMSHTML']['CustomerCustomerSignup']) : null;
$CustomerCustomerSignupVerification = isset($config['SMSHTML']['CustomerCustomerSignupVerification']) ? stripcslashes($config['SMSHTML']['CustomerCustomerSignupVerification']) : null;
$CustomerOrderPlaced = isset($config['SMSHTML']['CustomerOrderPlaced']) ? stripcslashes($config['SMSHTML']['CustomerOrderPlaced']) : null;
$CustomerOrderStatusChanged = isset($config['SMSHTML']['CustomerOrderStatusChanged']) ? stripcslashes($config['SMSHTML']['CustomerOrderStatusChanged']) : null;
$AdminCustomerSignup = isset($config['SMSHTML']['AdminCustomerSignup']) ? stripcslashes($config['SMSHTML']['AdminCustomerSignup']) : null;
$AdminCustomerSignupScheduled = isset($config['SMSHTML']['AdminCustomerSignupScheduled']) ? stripcslashes($config['SMSHTML']['AdminCustomerSignupScheduled']) : null;
$AdminOrderPlaced = isset($config['SMSHTML']['AdminOrderPlaced']) ? stripcslashes($config['SMSHTML']['AdminOrderPlaced']) : null;
$AdminOrderReturnRequest = isset($config['SMSHTML']['AdminOrderReturnRequest']) ? stripcslashes($config['SMSHTML']['AdminOrderReturnRequest']) : null;
$AdminContactInquiry = isset($config['SMSHTML']['AdminContactInquiry']) ? stripcslashes($config['SMSHTML']['AdminContactInquiry']) : null;
?>
<!DOCTYPE html>
<html>
	<head>
