...
echo '<script>alert(41);</script>';
	...
	//$permission_url =$_GET['shop']."/admin/oauth/authorize?client_id=2f32ee6aa7b785c18281b4cf8fc26346&scope=read_content&redirect_uri=https://smscountry.herokuapp.com/";
